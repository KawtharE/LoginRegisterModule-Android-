...
public class RegisterActivity extends Activity {
    ...
    @BindView(R.id.governorate) EditText inputGovernorate;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                String governorate = inputGovernorate.getText().toString().trim();
                String email = inputEmail.getText().toString().trim();
                String mobile = inputMobile.getText().toString().trim();
                String password = inputPassword.getText().toString();
                String passwordR = reEnterPasswordText.getText().toString();

                if (!firstname.isEmpty() && !lastname.isEmpty() && !address.isEmpty() && !city.isEmpty() && !governorate.isEmpty()
                        && !mobile.isEmpty()
                    ...
                    if (email.isEmpty() || !android.util.Patterns.EMAIL_ADDRESS.matcher(email).matches()) {
                        ...
                        if (password.equals(passwordR)) {
                            registerUser(firstname, lastname, address, city, governorate, email, mobile, password);
                        } else {
    ...
    /**
     * Function to store user in MySQL database will post params(tag, firstname, lastname, address, city, governorate
    ...
    private void registerUser(final String firstname, final String lastname, final String address, final String city,
                              final String governorate, final String email, final String mobile,
